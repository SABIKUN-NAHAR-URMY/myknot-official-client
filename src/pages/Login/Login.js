...
const Login = () => {
    ...
    return (
        <div className='h-[800px] flex justify-center items-center'>
            <div className='w-96 p-7 border rounded-lg shadow-2xl'>
                ...
                <p className='text-sm text-center'>New to MyKnot? <Link className='text-secondary' to='/signup'>Create New Account</Link></p>
